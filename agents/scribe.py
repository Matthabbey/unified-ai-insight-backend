...
class ScribeAgent:
    ...
    async def draft_email(
        ...
        recipient_type: Annotated[str, "Who is receiving the email: customer, vendor, internal, regulator"] = "internal",
        tone: Annotated[str, "Email tone: formal, professional, apologetic, urgent"] = "professional",
    ) -> str:
        try:
            # In production: calls GPT with context
            # For demo: returns realistic MTN-branded draft
            ...
            logger.error(f"Scribe draft_email failed: {e}")
...
Generated by MTN Atlas AI — {audience.title()} Brief
...
Prepared by: MTN Atlas Intelligence Platform
...
Supporting data available in MTN Atlas dashboard.""",
        })
...
This memo was drafted by MTN Atlas AI. Please review before distribution.
